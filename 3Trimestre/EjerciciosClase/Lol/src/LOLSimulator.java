...
/**
 * Esta clase representa un simulador de League of Legends.
 * Permite seleccionar campeones, asignarles roles y simular enfrentamientos.
 */
public class LOLSimulator extends JFrame {
    ...
    /**
     * Constructor de la clase LOLSimulator.
     * Inicializa la interfaz gráfica y carga los datos de los campeones.
     */
    public LOLSimulator() {
     ...
     *
     * @return Un mapa con los nombres de los campeones como claves y los objetos Champion como valores.
     */
     ...
     * Actualmente, esta función solo muestra un resultado de ejemplo.
     */
     ...
     *
     * @param fileName El nombre del archivo en el que se guardará la configuración.
     */
     ...
     *
     * @param fileName El nombre del archivo del que se cargará la configuración.
     */
